...
$(document).ready(function() {
	...
	$(".high .monospace").css({ "width": Math.round(volume_size * monospace_width) + "px" });
	$(".low .monospace").css({ "width": Math.round(volume_size * monospace_width) + "px" });
	$(".PCP .monospace").css({ "width": Math.round(volume_size * monospace_width) + "px" });
	$(".pricechange .monospace").css({ "width": Math.round(volume_size * monospace_width) + "px" });
	}
	else {
