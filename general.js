...
let fontsize;
if (fontsize == null) { fontsize = "'+volume_size+'";}
...
market_key = js_safe_key(market_id, exchange);
        ...
        '<div class="title" style="font-size: '+title_size+'px; color: #FFD700; font-weight: '+font_weight+';"><span id="asset_' + market_key + '">' + asset +
...
ticker_item =
 ...
 /////////////////////////////////////////////////////////////////////////
        ...
        if (highchange > lowchange) {
                        ...
                        lowp_item =
                         "<span class='spacing' style='font-size: 40px;'>&nbsp ( +" + lowp + "% )" + "</span></div>";
                        low_item =
                         "<span class='spacing' style='font-size: 32px;'>&nbsp " + market_symbol +
                         number_commas(low, set_min_decimals, set_max_decimals) + "</span><span style=' font-size: 40px; color: #FFF01F;'> :-(" + "</span></div>";
                        lowchange_item =
                         "<span class='spacing' style='font-size: 40px;'>Low: + " + market_symbol +
                         number_commas(lowchange, set_min_decimals, set_max_decimals) + "</span></div>";
                        }

        else {
                        highp_item =
                         "<span class='spacing' style='font-size: 40px;'>&nbsp ( " + highp + "% )" + "</span>";
                        high_item =
                         "<span class='spacing' style='font-size: 32px;'>&nbsp " + market_symbol +
                         number_commas(high, set_min_decimals, set_max_decimals) + "</span><span style=' font-size: 40px; color: #CCFF00;'> :-)" + "</span>";
                         highchange_item =
                         "<span class='spacing' style='font-size: 40px;'>&nbsp &nbsp High: - " + market_symbol +
                         number_commas(highchange, set_min_decimals, set_max_decimals) + "</span>";
